...
//         style={{ width: "100%", padding: "1rem", background: "orange", border: "none", borderRadius: "6px", color: "#000", fontFamily: "var(--font-mono)", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer" }}
//       >
//         {isSwitching ? "SWITCHING CHAIN..." : "⚠ SWITCH TO CORRECT NETWORK"}
//       </button>
//     );
//   }
...
//   return (
//     <div>
//       <div style={{ fontSize: "0.65rem", color: "var(--text-dim)", textAlign: "right", marginBottom: "0.5rem" }}>
//         BALANCE: {balance} {paymentDetails.token}
//         {insufficientFunds && <span style={{ color: "#ff5555", marginLeft: "0.5rem" }}>INSUFFICIENT</span>}
//       </div>
//       <button
//         onClick={handlePay}
...
//           background: isPending || insufficientFunds ? "var(--border)" : "var(--green)",
//           border: "none", borderRadius: "6px",
//           color: isPending || insufficientFunds ? "var(--text-dim)" : "#000",
...
//           ? "PROCESSING..."
//           : insufficientFunds
//           ? `INSUFFICIENT ${paymentDetails.token}`
